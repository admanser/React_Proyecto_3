          ...
          <Navbar.Toggle aria-controls="navbarScroll" />
            <Navbar.Collapse id="navbarScroll">
              <Nav className="me-auto my-2 my-lg-0">
                ...
                <NavLink className="nav-link" to="/Contact" style={({isActive})=>(isActive ? activeStyle : undefined)}>Contacto</NavLink>
                <NavLink className="nav-link" to="/Favorites" style={({isActive})=>(isActive ? activeStyle : undefined)}>Favoritos</NavLink>
                <div className="row"> 
